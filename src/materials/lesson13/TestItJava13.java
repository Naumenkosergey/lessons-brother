 ...
 */
    ...
    private static TestItJava13 run(String in) {
        return run(in, true);
    }

    private static TestItJava13 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new TestItJava13(clName, in, runMain);
    }
    ...
    private TestItJava13(String className, String in, boolean runMain) {
