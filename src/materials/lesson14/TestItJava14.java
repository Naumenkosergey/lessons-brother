 ...
 */
    ...
    private static TestItJava14 run(String in) {
        return run(in, true);
    }

    private static TestItJava14 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new TestItJava14(clName, in, runMain);
    }
    ...
    private TestItJava14(String className, String in, boolean runMain) {
