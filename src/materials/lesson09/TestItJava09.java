...
public class TestItJava09 {
    ...
    public void testTaskB2() throws Exception {
        ...
        run("").include("Там королевич мимоходом Пленяет грозного царя\n" +
                "Там ступа с Бабою Ягой Идёт бредёт сама собой\n" +
                "У лукоморья дуб зелёный Златая цепь на дубе том\n" +
                "Идёт направо песнь заводит Налево сказку говорит\n" +
                "Там царь Кащей над златом чахнет Там русский дух\n" +
 ...
 */
    ...
    private static TestItJava09 run(String in) {
        return run(in, true);
    }

    private static TestItJava09 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new TestItJava09(clName, in, runMain);
    }
    ...
    private TestItJava09(String className, String in, boolean runMain) {
