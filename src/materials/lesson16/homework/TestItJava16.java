package materials.lesson16.homework;
 ...
 */
    ...
    private static TestItJava16 run(String in) {
        return run(in, true);
    }

    private static TestItJava16 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new TestItJava16(clName, in, runMain);
    }
    ...
    private TestItJava16(String className, String in, boolean runMain) {
